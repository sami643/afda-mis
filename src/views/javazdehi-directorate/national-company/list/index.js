...
const IncorporationList = () => {
  ...
  const handleViewDetails = () => {
    ...
    navigate(`/javazdehi/national-company-list-view?id=${serializedData}`);
  };
  ...
  return (
    <CCard className="mb-5">
      <CCardHeader className="bg-warning m-0">
        <h4 className="p-2">د داخلي فابریکو لست</h4>
      </CCardHeader>
        ...
        <div className="container mb-4 ">
          <CRow className="py-3 mt-3 filter_container ">
            ...
            <div className="filterInputName">
              <label className="mx-2">د فابریکې نوم </label>
              <input
                type="email"
                class="form-control text-start inputt"
                id="floatingInput"
